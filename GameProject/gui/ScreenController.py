...
class ScreenController(ScreenManager):
    def __init__(self, **kwargs):
        ...
        self.add_widget(RoomEntryScreen(ui_manager=UIManager(), controller=self, name='room_entry'))
